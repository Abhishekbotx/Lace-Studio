        ...
        <div className="h-3/4 w-full flex justify-center items-center bg-gray-100">
            ...
            >
                <SwiperSlide className="relative bg-black" style={{
                    ...
                    <div className="text-white absolute bottom-0 content-small-screen right-12 flex flex-col items-center pb-4 px-4 w-[60vw]">
                ...
                <SwiperSlide className="relative">
                    ...
                    <div className='text-white z-50 text-[4vw] absolute bottom-20 left-1/3 bg-opacity-50 font-serif p-4 rounded-md capitalize'>
                        Now kurtis are one click away
                    </div>
                    <div className='text-white z-50 text-[2vw] absolute bottom-10 left-1/3 bg-opacity-50 font-serif p-4 rounded-md capitalize'>
                        join the culture; Find your unique style statement!
                    </div>
                </SwiperSlide>
